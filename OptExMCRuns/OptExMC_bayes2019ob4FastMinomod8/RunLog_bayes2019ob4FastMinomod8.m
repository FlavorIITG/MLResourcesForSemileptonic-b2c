...
<|"BestFitParameters" -> {rcv1 -> -1.9205250036245867, 
   rcs2 -> 1.214232330104862}, "ParameterErrors" -> 
  {rcv1 -> 0.3455604116740023, rcs2 -> 0.6949876343839306}, 
 "AverageAcceptance" -> 0.0653411513880909, 
 "TimeSpent" -> 351.9515317`9.998027853097492, "NumSteps" -> 200000, 
 ...
 "BurnEnd" -> 20000, "CorrelationMatrix" -> MatrixForm[{{0.9999999999999998, 
   -0.34457579229720386}, {-0.34457579229720386, 0.9999999999999997}}], 
 "LogDensity" -> CompiledFunction[{11, 12.1, 5148}, {{_Real, 1}}, 
   {{3, 1, 0}, {3, 0, 17}}, {{-2.2937201434824512, {3, 0, 33}}, 
    ...
    {1., {3, 0, 10}}, {-9.192635512506579, {3, 0, 25}}, 
    {-0.8340409272249723, {3, 0, 19}}, {True, {1, 0, 1}}, {10, {2, 0, 7}}, 
    {5.140311492443284, {3, 0, 22}}, {-3.2071578977703616, {3, 0, 26}}, 
    {1.0112572591407385, {3, 0, 15}}, {-5, {2, 0, 4}}, 
    {-18.385271025013157, {3, 0, 27}}, {-3.207157897770362, {3, 0, 34}}, 
    {10.280622984886568, {3, 0, 21}}, {57.255177598293415, {3, 0, 37}}, 
    {1.488757993959067, {3, 0, 8}}, {-98.7797002443067, {3, 0, 6}}, 
    {5, {2, 0, 5}}, {-1.7797162035136925*^308, {3, 0, 41}}, {-2, {2, 0, 6}}, 
    {7.2291999857175, {3, 0, 4}}, {2, {2, 0, 1}}, {-1, {2, 0, 8}}, 
    {-21.788152282972597, {3, 0, 18}}, {1, {2, 0, 2}}, 
    {-0.1303241740439184, {3, 0, 7}}, {2.022514518281477, {3, 0, 13}}, 
    {0.7866483920144183, {3, 0, 20}}, {7., {3, 0, 39}}, {0.5, {3, 0, 5}}, 
    {-4.5874402869649025, {3, 0, 35}}}, {6, 10, 42, 0, 3}, 
         ...
         Block[{rcv1, rcs2}, {rcv1, rcs2} = OptEx`Private`arglist$; 
           CompiledFunction[{11, 12.1, 7196}, {_Real, _Real}, 
             {{3, 0, 0}, {3, 0, 1}, {3, 0, 14}}, {{-2.2937201434824512, {3, 
              ...
              {-9.192635512506579, {3, 0, 23}}, {-0.8340409272249723, {3, 0, 
                17}}, {10, {2, 0, 3}}, {5.140311492443284, {3, 0, 20}}, 
              {-3.2071578977703616, {3, 0, 24}}, {1.0112572591407385, {3, 0, 
                13}}, {-5, {2, 0, 0}}, {-18.385271025013157, {3, 0, 25}}, 
              {-3.207157897770362, {3, 0, 32}}, {10.280622984886568, {3, 0, 
                19}}, {57.255177598293415, {3, 0, 35}}, {1.488757993959067, {
              ...
              {-21.788152282972597, {3, 0, 16}}, {-0.1303241740439184, {3, 0, 
                ...
                3, 0, 18}}, {7., {3, 0, 37}}, {0.5, {3, 0, 3}}, 
              {-4.5874402869649025, {3, 0, 33}}}, {4, 6, 38, 0, 0}, 
             {{16, 6, 1, 7}, {40, 56, 3, 0, 1, 3, 0, 9}, {16, 8, 9, 10}, 
              ...
              {7, 26, 12}, {13, 2, 15, 12, 14}, {1}}, Function[{rcv1, rcs2}, 
            ...
            {rcv1, rcs2}]][OptEx`Private`pts] != -Infinity, 
        ...
        {rcv1, rcs2} = OptEx`Private`arglist$; 
         CompiledFunction[{11, 12.1, 7196}, {_Real, _Real}, 
           {{3, 0, 0}, {3, 0, 1}, {3, 0, 14}}, {{-2.2937201434824512, 
            ...
            {-6.470398369149748, {3, 0, 30}}, {1., {3, 0, 8}}, 
            {-9.192635512506579, {3, 0, 23}}, {-0.8340409272249723, 
             {3, 0, 17}}, {10, {2, 0, 3}}, {5.140311492443284, {3, 0, 20}}, 
            {-3.2071578977703616, {3, 0, 24}}, {1.0112572591407385, 
             {3, 0, 13}}, {-5, {2, 0, 0}}, {-18.385271025013157, {3, 0, 25}}, 
            {-3.207157897770362, {3, 0, 32}}, {10.280622984886568, 
             {3, 0, 19}}, {57.255177598293415, {3, 0, 35}}, 
            {1.488757993959067, {3, 0, 6}}, {-98.7797002443067, {3, 0, 4}}, 
            {5, {2, 0, 1}}, {-2, {2, 0, 2}}, {7.2291999857175, {3, 0, 2}}, 
            {-1, {2, 0, 4}}, {-21.788152282972597, {3, 0, 16}}, 
            {-0.1303241740439184, {3, 0, 5}}, {2.022514518281477, 
             {3, 0, 11}}, {0.7866483920144183, {3, 0, 18}}, {7., {3, 0, 37}}, 
            {0.5, {3, 0, 3}}, {-4.5874402869649025, {3, 0, 33}}}, 
           {4, 6, 38, 0, 0}, {{16, 6, 1, 7}, {40, 56, 3, 0, 1, 3, 0, 9}, 
            {16, 8, 9, 10}, {16, 11, 0, 9}, {16, 6, 1, 0, 12}, 
            {40, 56, 3, 0, 0, 3, 0, 14}, {16, 13, 14, 15}, {13, 5, 7, 10, 9, 
             12, 15, 14}, {40, 56, 3, 0, 14, 3, 0, 7}, {16, 4, 7, 14}, 
            {16, 18, 1, 12}, {40, 56, 3, 0, 1, 3, 0, 15}, {16, 8, 15, 7}, 
            {16, 19, 0, 10}, {16, 18, 1, 0, 9}, {40, 56, 3, 0, 0, 3, 0, 15}, 
            {16, 20, 15, 21}, {13, 17, 12, 7, 10, 9, 21, 15}, 
            {40, 56, 3, 0, 15, 3, 0, 12}, {16, 16, 12, 15}, {16, 24, 1, 9}, 
            {40, 56, 3, 0, 1, 3, 0, 21}, {16, 8, 21, 12}, {16, 25, 0, 7}, 
            {16, 24, 1, 0, 10}, {40, 56, 3, 0, 0, 3, 0, 21}, 
            ...
            {40, 56, 3, 0, 21, 3, 0, 9}, {16, 24, 1, 12}, {40, 56, 3, 0, 1, 
             3, 0, 7}, {16, 8, 7, 10}, {16, 28, 0, 26}, {16, 24, 1, 0, 21}, 
            {40, 56, 3, 0, 0, 3, 0, 7}, {16, 27, 7, 29}, {13, 27, 12, 10, 26, 
             21, 29, 7}, {40, 56, 3, 0, 7, 3, 0, 12}, {40, 60, 3, 0, 12, 3, 
             0, 7}, {16, 22, 9, 7, 12}, {16, 32, 1, 26}, {40, 56, 3, 0, 1, 3, 
             0, 21}, {16, 8, 21, 29}, {16, 33, 0, 9}, {16, 32, 1, 0, 7}, 
            {40, 56, 3, 0, 0, 3, 0, 10}, {16, 31, 10, 21}, {13, 31, 26, 29, 
             9, 7, 21, 10}, {40, 56, 3, 0, 10, 3, 0, 26}, {16, 24, 1, 29}, 
            {40, 56, 3, 0, 1, 3, 0, 9}, {16, 8, 9, 7}, {16, 35, 0, 21}, 
            {16, 24, 1, 0, 10}, {40, 56, 3, 0, 0, 3, 0, 9}, {16, 34, 9, 36}, 
            {13, 34, 29, 7, 21, 10, 36, 9}, {40, 56, 3, 0, 9, 3, 0, 29}, 
            {40, 60, 3, 0, 29, 3, 0, 9}, {16, 30, 26, 9, 29}, 
            {13, 14, 15, 12, 29, 14}, {16, 3, 14, 15}, {10, 0, 14}, 
            {10, 1, 12}, {27, 4, 37, 14, 0, 12, 0}, {2, 0, 6}, {10, 0, 14}, 
            {10, 1, 12}, {27, 4, 37, 14, 1, 12, 1}, {5, 1, 3}, {3, 2}, 
            {5, 2, 3}, {2, 3, 7}, {10, 3, 14}, {40, 34, 3, 0, 14, 3, 0, 12}, 
            {10, 2, 14}, {16, 14, 12, 14}, {7, 14, 12}, {3, 4}, 
            {47, DirectedInfinity, 2, 0, 4, 2, 0, 5}, {10, 5, 26}, 
            {7, 26, 12}, {13, 2, 15, 12, 14}, {1}}, Function[{rcv1, rcs2}, 
            7.2291999857175 + (-98.7797002443067*(-0.1303241740439184 + 
                  1.488757993959067*rcs2 + 1.*rcs2^2 + 2.022514518281477*
                  ...
                  0.7866483920144183*rcs2 + 1.*rcs2^2 + 10.280622984886568*
                   ...
                   3.2071578977703616*rcs2 + 1.*rcs2^2 - 18.385271025013157*
                    rcv1 - 3.2071578977703616*rcs2*rcv1 - 9.192635512506579*
                    rcv1^2)^2)/(28.62758827337262 - 3.2071578977703616*rcs2 + 
                  1.*rcs2^2 + 57.25517654674524*rcv1 - 3.2071578977703616*
                   rcs2*rcv1 + 28.62758827337262*rcv1^2)^2 - 
               (6.470398369149748*(-2.2937201434824512 - 3.207157897770362*
                    rcs2 + 1.*rcs2^2 - 4.5874402869649025*rcv1 - 
                   3.207157897770362*rcs2*rcv1 - 2.2937201434824512*rcv1^2)^
                  2)/(28.627588799146707 - 3.2071578977703616*rcs2 + 
                  1.*rcs2^2 + 57.255177598293415*rcv1 - 3.2071578977703616*
                   rcs2*rcv1 + 28.627588799146707*rcv1^2)^2)/2 + 
             Piecewise[{{-2*Log[10], -5 <= rcv1 <= 5 && -5 <= rcs2 <= 5}}, 
              -Infinity]], Evaluate] @@ {rcv1, rcs2}]][OptEx`Private`pts], 
