...
<|"BestFitParameters" -> {rcv1 -> -1.9950928620448143, 
   rcs2 -> 1.0977544316218513}, "ParameterErrors" -> 
  {rcv1 -> 0.06216341810041784, rcs2 -> 0.6996025039280918}, 
 "AverageAcceptance" -> 0.06483526509468122, 
 "TimeSpent" -> 351.7000776`9.997717457636764, "NumSteps" -> 200000, 
 "Parameters" -> {rcv1, rcs2}, "ProposalSpreads" -> {0.2, 0.2}, 
 "ParameterDomains" -> {Reals, Reals}, "BurnFraction" -> 0.1, 
 "BurnEnd" -> 20000, "CorrelationMatrix" -> 
  MatrixForm[{{1., 0.9057231632162991}, {0.9057231632162991, 
   1.0000000000000007}}], "LogDensity" -> CompiledFunction[{11, 12.1, 5148}, 
